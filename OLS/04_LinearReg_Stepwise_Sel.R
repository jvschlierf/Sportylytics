...
Back_reg <- ols_step_backward_p(lm_model, prem = 0.1) #I want a p-value of at least 0.05
Back_reg
...
Forw_reg2 <- ols_step_forward_aic(lm_model, progress = TRUE) #I want a p-value of at least 0.05
Forw_reg2
